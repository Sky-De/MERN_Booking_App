      ...
      <section className="hotelPageMain__intro">
        ...
        <section className="hotelPageMain__detailsCon">
          ...
          <section className="hotelPageMain__price">
            <h3 className="hotelPageMain__price--title">Perfect for a 9-night stay!</h3>
            <p className="hotelPageMain__price--description">Located in the real heart of Krakow, this property has an
                excellent location score of 9.8!</p>
            <strong className="hotelPageMain__price--number">$945<span> (9 Nights)</span></strong>
            <ReserveBtn/>
          </section>
        </section>
      </>}
